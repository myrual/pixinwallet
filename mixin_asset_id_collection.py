...
MIXIN_DEFAULT_CHAIN_GROUP = [BTC_ASSET_ID, EOS_ASSET_ID, USDT_ASSET_ID, ETC_ASSET_ID, XRP_ASSET_ID, XEM_ASSET_ID, ETH_ASSET_ID, DASH_ASSET_ID, DOGE_ASSET_ID, LTC_ASSET_ID, SIA_ASSET_ID, ZEN_ASSET_ID, ZEC_ASSET_ID, BCH_ASSET_ID, CNB_ASSET_ID]

Block_interval = {BTC_ASSET_ID:10*60, EOS_ASSET_ID:0.5, ETC_ASSET_ID:14, ETH_ASSET_ID:10, DASH_ASSET_ID:(120+40), DOGE_ASSET_ID:60, LTC_ASSET_ID:(120+40), ZEC_ASSET_ID:(120+40), BCH_ASSET_ID:10*60}
